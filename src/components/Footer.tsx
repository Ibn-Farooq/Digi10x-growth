        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              {/* Social Placeholders */}
              {[1, 2, 3, 4].map((i) => (
                <a key={i} href="#" className="w-8 h-8 rounded-full bg-tech-blue-light flex items-center justify-center text-gray-400 hover:text-neon-cyan hover:bg-neon-cyan/10 transition-colors">
